...
export class ConsoleRolesOnboardingConstants {
    ...
    public static readonly ROLE_ASSIGNMENTS_ROLE_ID: string = "role_assignments";
    ...
    public static readonly ORG_ROLE_ASSIGNMENTS_ROLE_ID: string = "org_role_assignments";
